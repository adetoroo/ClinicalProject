...
proc import datafile = "C:\Users\User\Google Drive\SAS Programming Training\Indian-Online Training\Clinical\LIVE PROJECT\QPS3\RAW\Demo_Raw.xlsx" out=raw.demo_raw dbms=xlsx replace;
run;
